...
contract UniswapQuote {
    ...
    address sqfu = 0xf1B99e3E573A1a9C5E6B2Ce818b617F0E664E86B;
    ...
    function getSqfuPrice(uint256 _quantity) external returns (uint256) {
        return quoter.quoteExactInputSingle((sqfu), (weth), 3000, _quantity, 0);
    }
}
