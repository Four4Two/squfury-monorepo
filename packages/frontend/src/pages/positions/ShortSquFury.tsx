...
export default function ShortSquFury() {
  ...
  return (
    <div className={classes.position}>
      <div className={classes.positionTitle}>
        <Typography>Short SquFury</Typography>
        ...
        <div className={classes.innerPositionData}>
          <div style={{ width: '50%' }}>
            ...
            {isPositionLoading ? (
              ...
              <Typography variant="body1" id="pos-page-short-osqfu-bal">
                {squfuryAmount.toFixed(8) + ' oSQFU'}
              </Typography>
            )}
          </div>
          <div style={{ width: '50%' }}>
