...
export default function MintedSquFury({ vaultExists }: Props) {
  ...
  return (
    <div className={classes.position}>
      <div className={classes.positionTitle}>
        <Typography>Minted SquFury</Typography>
        ...
        <div className={classes.innerPositionData}>
          <div style={{ width: '50%' }}>
            ...
            <Typography variant="body1">
              {isPositionLoading ? 'Loading' : <span id="pos-page-minted-osqfu-bal">{mintedDebt.toFixed(8)}</span>}{' '}
              &nbsp; oSQFU
            </Typography>
          </div>
        </div>
