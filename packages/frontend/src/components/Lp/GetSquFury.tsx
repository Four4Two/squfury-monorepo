  ...
  return (
    <>
      <Typography className={classes.title}>
        {lpState.obtainMethod === OBTAIN_METHOD.BUY ? 'Buy SquFury to LP' : 'Mint SquFury to LP'}
      </Typography>
