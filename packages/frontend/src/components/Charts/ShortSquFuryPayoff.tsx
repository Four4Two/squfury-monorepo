import useSquFuryShortPayOffGraph from '@hooks/payOffGraph/useSquFuryShortPayOffGraph'
...
const ShortSquFuryPayoff: React.FC<{ ethPrice: number; collatRatio: number; vaultType?: Vaults }> = ({
  ethPrice,
  collatRatio,
  vaultType,
}) => {
  const {
    ...
    payout14: values14,
    payout28: values28,
  } = useSquFuryShortPayOffGraph(ethPrice, collatRatio)
...
export default memo(ShortSquFuryPayoff)
