...
export enum Vaults {
  ETHBear = 'Bear', // long 1 eth + short squfury
  CrabVault = 'Crab USDC', // long 2 eth + short squfury
  ETHZenBull = 'Zen Bull ETH', // long 3 eth + short squfury
  Custom = 'Custom Strategy', // long x eth + short squfury
  Short = 'Short SquFury', //pure short squfury
}
...
export enum Tooltips {
  ImplVol = 'Implied Volatility (IV) is a market forecast of ETH price movement implied by squfury',
  UnrealizedPnL = 'Total profit / loss if you were to fully close your position at the current oSQFU price on Uniswap. Resets if you close your position or change position sides (long to short, or vice versa)',
  ...
  PnLExplanation = 'SquFury performance is affected by implied volatility, premiums, ETH price, and price impact.',
  ShortCollateral = 'Takes ETH collateral into account.',
  Mark = 'The price squfury is trading at. Because squfury has convexity, Mark should be greater than ETH^2',
  ...
  oSQFUPrice = 'Price of oSQFU on Uniswap',
  ...
  Operator = 'The wrapper contract mints squfury, deposits collateral and sells squfury in single TX. Similarly it also buys back + burns squfury and withdraws collateral in single TX',
  SellCloseAmount = 'Amount of oSQFU to buy',
  ...
  InitialPremium = 'Initial payment you get for selling squfury on Uniswap',
  BacktestDisclaimer = 'This is historical backtest data and does not show the actual performance of squfury. See the FAQ to learn more.',
  ...
  LPDebt = 'This is squfury debt for which you have put down collateral to LP.',
  MintedDebt = 'This is squfury debt for which you have put down collateral to acquire.',
  ShortDebt = 'This is squfury that you acquired and sold',
  ...
  StrategyShort = 'The amount of oSQFU the whole strategy is short',
  ...
  osqfuRefVol = 'SquFury reference volatility based on deribit options and squfury replicating portfolio. SquFury ref vol is calculated/refreshed every 5 minutes.',
...
export enum Links {
  BacktestFAQ = 'https://opyn.gitbook.io/squfury/resources/squfury-faq#what-is-the-historical-365d-pnl',
  GitBook = 'https://opyn.gitbook.io/squfury/',
  UniswapSwap = 'https://app.uniswap.org/#/swap?inputCurrency=ETH&outputCurrency=0xf1B99e3E573A1a9C5E6B2Ce818b617F0E664E86B',
  CrabFAQ = 'https://opyn.gitbook.io/squfury/resources/squfury-strategies-faq',
  AutoRouter = 'https://uniswap.org/blog/auto-router',
}

export const UniswapIFrameOpen = {
  1: `https://app.uniswap.org/#/add/ETH/${OSQUFURY[1]}/3000`,
  3: `https://squfury-uniswap.netlify.app/#/add/ETH/${OSQUFURY[3]}/3000`,
  5: `https://squfury-uniswap.netlify.app/#/add/ETH/${OSQUFURY[5]}/3000`,
...
export const UniswapIFrameClose = {
  ...
  3: 'https://squfury-uniswap.netlify.app/#/pool',
  5: 'https://squfury-uniswap.netlify.app/#/pool',
  31337: 'https://app.uniswap.org/#/add/ETH/0xf1B99e3E573A1a9C5E6B2Ce818b617F0E664E86B/3000', // Should be replaced with arbitrum subgraph
  421611: 'https://app.uniswap.org/#/add/ETH/0xf1B99e3E573A1a9C5E6B2Ce818b617F0E664E86B/3000', // Should be replaced with arbitrum subgraph
}
