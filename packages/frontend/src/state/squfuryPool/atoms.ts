...
export const squfuryTokenAtom = atom<Token | null>(null)
...
export const squfuryInitialPriceAtom = atom(BIG_ZERO)
export const squfuryInitialPriceErrorAtom = atom('')
export const squfuryPriceeAtom = atom(BIG_ZERO) // not being used
